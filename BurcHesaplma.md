...
```java
    ...
    System.out.print("Doğum ayı giriniz(Orn:Eylül ise 9):");
    ay = reader.nextInt()-1;
    ...
    if((ay<12 && ay>=0) && (gun<32 && gun>0)) {
        ...
        for(int i=0 ;i<burc.length;i++) {
            ...
            String[] burcInfo = burc[i].split("-"); // burcInfo : "21_2_0","20_3_0","Koc"
            String burcIsim = burcInfo[2]; // burcIsim:"Koc"
            String[] beforeDateString = burcInfo[0].split("_"); //beforeDateString : "21","2","0"
            String[] afterDateString = burcInfo[1].split("_");//afterDateString : "20","3","0"
